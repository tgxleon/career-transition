      ...
      <div className="space-y-5">
        ...
        <div className="card space-y-3">
          ...
          <p className="text-xs text-gray-500">
            One click adds it to your reminders list.
          </p>
          <div className="flex flex-col gap-2">
            <button
              ...
              onClick={() =>
                quickReminder(
                  "interview",
                  `Interview: ${job.role} @ ${job.company}`,
                  new Date(
                    new Date(job.interviewDate).getTime() - 24 * 3600_000
                  )
                )
              }
            >
              📅 Interview prep — 1 day before interview
            </button>
            <button
              className="btn-secondary justify-start text-left"
              disabled={!job.interviewDate}
              onClick={() =>
                quickReminder(
                  ...
                  new Date(
                    new Date(job.interviewDate).getTime() + 20 * 3600_000
                  )
                )
              }
            >
              ✉️ Thank-you email — day after interview
            </button>
            <button
              className="btn-secondary justify-start text-left"
              onClick={() =>
